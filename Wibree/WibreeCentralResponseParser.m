  ...
  didConnectPeripheral:(CBPeripheral *)peripheral
{
    ...
    [peripheral discoverServices:@[[CBUUID UUIDWithString:Document.WIBREE_SERVICE_UUID]]];
}
             ...
             error:(NSError *)error
{
    ...
    for (CBCharacteristic *characteristic in service.characteristics) {
        ...
        if ([characteristic.UUID isEqual:[CBUUID UUIDWithString:Document.WIBREE_CHARACTERISTIC_UUID]]) {
